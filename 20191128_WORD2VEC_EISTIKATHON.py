...
# Embedddings [Non supervisé car pas de label [négatif, positif par exemple] :
# ___
# 
# <br>
# 
# On veut créer un modèle d'analyse sémantique.
# Avec, on peut donc trouver des mots similaires, ou totalement opposés.
# 
# <br>
# <br>
# <br>
...
# Classifier
# ___
# Si on veut classifier du texte (exemple, savoir si la description de l'évenement est à destination d'un médecin ou plombier)
# on utilise sklearn, et des modèles de classifier (/!\ attention il faut donc des données labélisées pour entrainer le modèle)
# 
